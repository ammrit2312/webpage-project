...
app.post("/buying/red_printed", function(req, res){
    ...
    const cloth_arr = ["Red Printed T-Shirt By HRX", "HRX Shoes", "Sport Trouser", "Puma Polo T-Shirt", "Grey Shoes", "Black T-Shirt", "HRX Socks", "Sport Watch", "Sport Watch", "Sport Shoes", "Causal Shoes", "Nike Trouser"];
